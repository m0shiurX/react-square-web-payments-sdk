export declare const keyframes: (style: {
    ...
    (): string;
    name: string;
}, styled: <Type extends keyof import("react/jsx-runtime").JSX.IntrinsicElements | React.ComponentType<any> | import("@stitches/react/types/util").Function, Composers extends (string | React.ComponentType<any> | import("@stitches/react/types/util").Function | {
    [name: string]: unknown;
